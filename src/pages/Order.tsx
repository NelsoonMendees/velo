  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (paymentMethod === 'financiamento') {
      try {
        ...
        orderStatus = determineCreditStatus(score, entryPercentage);
              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.name && <p data-testid="checkout-name-error" className="text-sm text-destructive">{errors.name}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {errors.surname && <p data-testid="checkout-surname-error" className="text-sm text-destructive">{errors.surname}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {errors.email && <p data-testid="checkout-email-error" className="text-sm text-destructive">{errors.email}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.phone && <p data-testid="checkout-phone-error" className="text-sm text-destructive">{errors.phone}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.cpf && <p data-testid="checkout-cpf-error" className="text-sm text-destructive">{errors.cpf}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.store && <p data-testid="checkout-store-error" className="text-sm text-destructive">{errors.store}</p>}
                  </div>
                </div>
              </section>
              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {errors.terms && <p data-testid="checkout-terms-error" className="text-sm text-destructive mt-1">{errors.terms}</p>}
                  </div>
                </div>
              </section>
